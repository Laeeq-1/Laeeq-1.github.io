...
This simulation models the supply chain for Vietnamese coffee production — including farming, processing, transport, and warehousing.  
It was developed as part of our coursework to better understand how different events (e.g., weather disruptions like monsoons) could affect production flow and operational costs.  
The code was written in Python using the SimPy library and produces a full year of data for analysis.
